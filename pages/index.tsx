    ...
    <Layout title="SYTA.CO">
      <div className="text-primary relative overflow-hidden w-full" css={{ height: '250vh' }}>
        ...
        <div className="absolute p-4" css={{ top: '10vh', right: '45%' }}>
          <Triangle className="absolute w-32 h-32 origin-center transform -rotate-90 ml-12" />
          <Triangle className="absolute w-32 h-32 origin-center transform rotate-90 mt-20" />
        </div>
        {/* 2021 */}
        ...
        {/* syta.co */}
        <div className="font-mono text-3xl md:text-5xl mt-10 mb-4 md:my-6 ml-4 md:ml-32 lg:ml-40">
          <h2>syta.co</h2>
        </div>
        ...
        >
          <div className="inline-block justify-start xl:justify-end pl-6 xl:pl-20 pr-2 md:pr-8 py-2 md:py-6"
            style={{ backgroundImage: 'url("/img/diagonal-stripes.svg")' }}
          >
          ...
          <div className="text-3xl md:text-5xl xl:text-7xl flex mt-8 ml-5 xl:ml-24" style={{ lineHeight: .8 }}>
